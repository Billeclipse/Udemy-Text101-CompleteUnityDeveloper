...
public class TextController : MonoBehaviour {
	...
	void state_cell (){
		text.text = "You are in a prison cell, "
			+ "and you want to escape. There are some dirty sheets " 
			+ "on the bed, a mirror on the wall, and the door is "
	...
	void state_sheets_0 (){
		text.text = "You can't believe you sleep in these things. Surely it's "
			+ "time someone changed them. The pleasures of prison life I guess! \n\n"
	...
	void state_sheets_1 (){
		text.text = "Holdning a mirror in your hand doesn't make the sheets look "
			+ "any better... \n\n"
				+ "Press R to Return to roaming your cell";	
		if(Input.GetKeyDown(KeyCode.R)){
			myState = States.cell_mirror;
